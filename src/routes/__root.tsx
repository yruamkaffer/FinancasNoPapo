    ...
    head: () => ({
      meta: [
        ...
        { title: "Finanças no Papo — controle financeiro em conversa" },
        {
          name: "description",
          content:
            "Registre receitas e despesas conversando naturalmente. Um jeito acolhedor e acessível de cuidar do seu dinheiro.",
        },
        ...
        { property: "og:title", content: "Finanças no Papo" },
        {
          ...
          content:
            "Controle financeiro pessoal em linguagem natural, com Design Universal.",
        },
